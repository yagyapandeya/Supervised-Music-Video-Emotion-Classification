...
from music_video_face_net import video_net 
...
video3D_fast, video3D_slow, video3D_face, melphase, target = loadeddata["video3D_fast"], loadeddata["video3D_slow"], loadeddata["face_fast"], loadeddata["melphase"], loadeddata["target"]
...
network = video_net(video_input_fast, video_input_slow, audio_input_size, video_input_face)

loss, acc = network.evaluate(x=[video3D_fast, video3D_slow, melphase, video3D_face], y=target, batch_size=10, verbose=0)
print('Test loss:', loss)
print('Test accuracy:', acc)

# make a prediction
predictions = network.predict(x=[video3D_fast, video3D_slow, melphase, video3D_face],batch_size=10, verbose=0)    #x=X_test
