...
from video_net import video_net
...
video3D_fast, video3D_slow, target = loadeddata["video3D_fast"], loadeddata["video3D_slow"], loadeddata["target"]
#video3D_fast, video3D_slow, target = loadeddata["X_fast"], loadeddata["X_slow"], loadeddata["target"]
...
print("The video3D_slow data shape", video3D_slow.shape)
...
network = video_net(video_input_fast, video_input_slow)

loss, acc = network.evaluate(x=[video3D_fast, video3D_slow], y=target, batch_size=5, verbose=0)
print('Test loss:', loss)
print('Test accuracy:', acc)

# make a prediction
predictions = network.predict(x=[video3D_fast, video3D_slow],batch_size=5, verbose=0)    #x=X_test
